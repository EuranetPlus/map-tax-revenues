export const config = {
	mapTitle: 'tax-revenue', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-tax-revenues.vercel.app/', // The url provided when deploying the map on Vercel
